...
console.log(getCountries(countries))
 ...
 // დავალება 2
function searchCountry(name2) {
     // იმპლემენტაცია
     var result = getCountries(countries).find(item => item.name === name2)
     console.log(result)
 }


searchCountry("Belgium");


//დავალება 3
function sortCountries() {
  // იმპლემენტაცია
  var shedegi = getCountries(countries).sort(function (a, b) {
    if (a.name < b.name) {
      return -1;
    }
    if (a.name > b.name) {
